...
extension ECDSA {
    class BinaryAscii {
        ...
        static func intFromHex(_ hexadecimal: String) -> CS.BigInt {
            return CS.BigInt(hexadecimal, radix: 16)!
        }

        static func hexFromInt(_ number: CS.BigInt) -> String {
        ...
        static func bitsFromHex(_ hexadecimal: String) -> String {
            let binary = String(CS.BigInt(hexadecimal, radix: 16)!, radix: 2)
